...
pub const READSTAT_MACHINE_IS_TWOS_COMPLEMENT: u32 = 0;
pub const SAS_ENDIAN_BIG: u32 = 0;
pub const SAS_ENDIAN_LITTLE: u32 = 1;
pub const SAS_FILE_FORMAT_UNIX: u8 = 49u8;
pub const SAS_FILE_FORMAT_WINDOWS: u8 = 50u8;
pub const SAS_ALIGNMENT_OFFSET_0: u32 = 34;
pub const SAS_ALIGNMENT_OFFSET_4: u32 = 51;
pub const SAS_COLUMN_TYPE_NUM: u32 = 1;
pub const SAS_COLUMN_TYPE_CHR: u32 = 2;
pub const SAS_SUBHEADER_SIGNATURE_ROW_SIZE: u32 = 4160223223;
pub const SAS_SUBHEADER_SIGNATURE_COLUMN_SIZE: u32 = 4143380214;
pub const SAS_SUBHEADER_SIGNATURE_COUNTS: u32 = 4294966272;
pub const SAS_SUBHEADER_SIGNATURE_COLUMN_FORMAT: u32 = 4294966270;
pub const SAS_SUBHEADER_SIGNATURE_COLUMN_MASK: u32 = 4294967288;
pub const SAS_SUBHEADER_SIGNATURE_COLUMN_ATTRS: u32 = 4294967292;
pub const SAS_SUBHEADER_SIGNATURE_COLUMN_TEXT: u32 = 4294967293;
pub const SAS_SUBHEADER_SIGNATURE_COLUMN_LIST: u32 = 4294967294;
pub const SAS_SUBHEADER_SIGNATURE_COLUMN_NAME: u32 = 4294967295;
pub const SAS_PAGE_TYPE_META: u32 = 0;
pub const SAS_PAGE_TYPE_DATA: u32 = 256;
pub const SAS_PAGE_TYPE_MIX: u32 = 512;
pub const SAS_PAGE_TYPE_AMD: u32 = 1024;
pub const SAS_PAGE_TYPE_MASK: u32 = 3840;
pub const SAS_PAGE_TYPE_META2: u32 = 16384;
pub const SAS_PAGE_TYPE_COMP: u32 = 36864;
pub const SAS_SUBHEADER_POINTER_SIZE_32BIT: u32 = 12;
pub const SAS_SUBHEADER_POINTER_SIZE_64BIT: u32 = 24;
pub const SAS_PAGE_HEADER_SIZE_32BIT: u32 = 24;
pub const SAS_PAGE_HEADER_SIZE_64BIT: u32 = 40;
pub const SAS_COMPRESSION_NONE: u32 = 0;
pub const SAS_COMPRESSION_TRUNC: u32 = 1;
pub const SAS_COMPRESSION_ROW: u32 = 4;
pub const SAS_COMPRESSION_SIGNATURE_RLE: &[u8; 9] = b"SASYZCRL\0";
pub const SAS_COMPRESSION_SIGNATURE_RDC: &[u8; 9] = b"SASYZCR2\0";
pub const SAS_DEFAULT_FILE_VERSION: u32 = 9;
...
extern "C" {
    pub fn machine_is_little_endian() -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ones_to_twos_complement1(num: ::std::os::raw::c_char) -> ::std::os::raw::c_char;
}
extern "C" {
    pub fn ones_to_twos_complement2(num: i16) -> i16;
}
extern "C" {
    pub fn ones_to_twos_complement4(num: i32) -> i32;
}
extern "C" {
    pub fn byteswap2(num: u16) -> u16;
}
extern "C" {
    pub fn byteswap4(num: u32) -> u32;
}
extern "C" {
    pub fn byteswap8(num: u64) -> u64;
}
extern "C" {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct sas_header_start_s {
    pub magic: [::std::os::raw::c_uchar; 32usize],
    pub a2: ::std::os::raw::c_uchar,
    pub mystery1: [::std::os::raw::c_uchar; 2usize],
    pub a1: ::std::os::raw::c_uchar,
    pub mystery2: [::std::os::raw::c_uchar; 1usize],
    pub endian: ::std::os::raw::c_uchar,
    pub mystery3: [::std::os::raw::c_uchar; 1usize],
    pub file_format: ::std::os::raw::c_char,
    pub mystery4: [::std::os::raw::c_uchar; 30usize],
    pub encoding: ::std::os::raw::c_uchar,
    pub mystery5: [::std::os::raw::c_uchar; 13usize],
    pub file_type: [::std::os::raw::c_char; 8usize],
    pub table_name: [::std::os::raw::c_char; 32usize],
    pub mystery6: [::std::os::raw::c_uchar; 32usize],
    pub file_info: [::std::os::raw::c_char; 8usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of sas_header_start_s"][::std::mem::size_of::<sas_header_start_s>() - 164usize];
    ["Alignment of sas_header_start_s"][::std::mem::align_of::<sas_header_start_s>() - 1usize];
    ["Offset of field: sas_header_start_s::magic"]
        [::std::mem::offset_of!(sas_header_start_s, magic) - 0usize];
    ["Offset of field: sas_header_start_s::a2"]
        [::std::mem::offset_of!(sas_header_start_s, a2) - 32usize];
    ["Offset of field: sas_header_start_s::mystery1"]
        [::std::mem::offset_of!(sas_header_start_s, mystery1) - 33usize];
    ["Offset of field: sas_header_start_s::a1"]
        [::std::mem::offset_of!(sas_header_start_s, a1) - 35usize];
    ["Offset of field: sas_header_start_s::mystery2"]
        [::std::mem::offset_of!(sas_header_start_s, mystery2) - 36usize];
    ["Offset of field: sas_header_start_s::endian"]
        [::std::mem::offset_of!(sas_header_start_s, endian) - 37usize];
    ["Offset of field: sas_header_start_s::mystery3"]
        [::std::mem::offset_of!(sas_header_start_s, mystery3) - 38usize];
    ["Offset of field: sas_header_start_s::file_format"]
        [::std::mem::offset_of!(sas_header_start_s, file_format) - 39usize];
    ["Offset of field: sas_header_start_s::mystery4"]
        [::std::mem::offset_of!(sas_header_start_s, mystery4) - 40usize];
    ["Offset of field: sas_header_start_s::encoding"]
        [::std::mem::offset_of!(sas_header_start_s, encoding) - 70usize];
    ["Offset of field: sas_header_start_s::mystery5"]
        [::std::mem::offset_of!(sas_header_start_s, mystery5) - 71usize];
    ["Offset of field: sas_header_start_s::file_type"]
        [::std::mem::offset_of!(sas_header_start_s, file_type) - 84usize];
    ["Offset of field: sas_header_start_s::table_name"]
        [::std::mem::offset_of!(sas_header_start_s, table_name) - 92usize];
    ["Offset of field: sas_header_start_s::mystery6"]
        [::std::mem::offset_of!(sas_header_start_s, mystery6) - 124usize];
    ["Offset of field: sas_header_start_s::file_info"]
        [::std::mem::offset_of!(sas_header_start_s, file_info) - 156usize];
};
pub type sas_header_start_t = sas_header_start_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct sas_header_end_s {
    pub release: [::std::os::raw::c_char; 8usize],
    pub host: [::std::os::raw::c_char; 16usize],
    pub version: [::std::os::raw::c_char; 16usize],
    pub os_vendor: [::std::os::raw::c_char; 16usize],
    pub os_name: [::std::os::raw::c_char; 16usize],
    pub extra: [::std::os::raw::c_char; 48usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of sas_header_end_s"][::std::mem::size_of::<sas_header_end_s>() - 120usize];
    ["Alignment of sas_header_end_s"][::std::mem::align_of::<sas_header_end_s>() - 1usize];
    ["Offset of field: sas_header_end_s::release"]
        [::std::mem::offset_of!(sas_header_end_s, release) - 0usize];
    ["Offset of field: sas_header_end_s::host"]
        [::std::mem::offset_of!(sas_header_end_s, host) - 8usize];
    ["Offset of field: sas_header_end_s::version"]
        [::std::mem::offset_of!(sas_header_end_s, version) - 24usize];
    ["Offset of field: sas_header_end_s::os_vendor"]
        [::std::mem::offset_of!(sas_header_end_s, os_vendor) - 40usize];
    ["Offset of field: sas_header_end_s::os_name"]
        [::std::mem::offset_of!(sas_header_end_s, os_name) - 56usize];
    ["Offset of field: sas_header_end_s::extra"]
        [::std::mem::offset_of!(sas_header_end_s, extra) - 72usize];
};
pub type sas_header_end_t = sas_header_end_s;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct sas_header_info_s {
    pub little_endian: ::std::os::raw::c_int,
    ...
    pub page_size: i64,
    pub page_header_size: i64,
    pub subheader_pointer_size: i64,
    pub page_count: i64,
    pub header_size: i64,
    pub creation_time: time_t,
    pub modification_time: time_t,
    pub table_name: [::std::os::raw::c_char; 32usize],
    pub file_label: [::std::os::raw::c_char; 256usize],
    pub encoding: *mut ::std::os::raw::c_char,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of sas_header_info_s"][::std::mem::size_of::<sas_header_info_s>() - 384usize];
    ["Alignment of sas_header_info_s"][::std::mem::align_of::<sas_header_info_s>() - 8usize];
    ["Offset of field: sas_header_info_s::little_endian"]
        [::std::mem::offset_of!(sas_header_info_s, little_endian) - 0usize];
    ["Offset of field: sas_header_info_s::u64_"]
        [::std::mem::offset_of!(sas_header_info_s, u64_) - 4usize];
    ["Offset of field: sas_header_info_s::vendor"]
        [::std::mem::offset_of!(sas_header_info_s, vendor) - 8usize];
    ["Offset of field: sas_header_info_s::major_version"]
        [::std::mem::offset_of!(sas_header_info_s, major_version) - 12usize];
    ["Offset of field: sas_header_info_s::minor_version"]
        [::std::mem::offset_of!(sas_header_info_s, minor_version) - 16usize];
    ["Offset of field: sas_header_info_s::revision"]
        [::std::mem::offset_of!(sas_header_info_s, revision) - 20usize];
    ["Offset of field: sas_header_info_s::pad1"]
        [::std::mem::offset_of!(sas_header_info_s, pad1) - 24usize];
    ["Offset of field: sas_header_info_s::page_size"]
        [::std::mem::offset_of!(sas_header_info_s, page_size) - 32usize];
    ["Offset of field: sas_header_info_s::page_header_size"]
        [::std::mem::offset_of!(sas_header_info_s, page_header_size) - 40usize];
    ["Offset of field: sas_header_info_s::subheader_pointer_size"]
        [::std::mem::offset_of!(sas_header_info_s, subheader_pointer_size) - 48usize];
    ["Offset of field: sas_header_info_s::page_count"]
        [::std::mem::offset_of!(sas_header_info_s, page_count) - 56usize];
    ["Offset of field: sas_header_info_s::header_size"]
        [::std::mem::offset_of!(sas_header_info_s, header_size) - 64usize];
    ["Offset of field: sas_header_info_s::creation_time"]
        [::std::mem::offset_of!(sas_header_info_s, creation_time) - 72usize];
    ["Offset of field: sas_header_info_s::modification_time"]
        [::std::mem::offset_of!(sas_header_info_s, modification_time) - 80usize];
    ["Offset of field: sas_header_info_s::table_name"]
        [::std::mem::offset_of!(sas_header_info_s, table_name) - 88usize];
    ["Offset of field: sas_header_info_s::file_label"]
        [::std::mem::offset_of!(sas_header_info_s, file_label) - 120usize];
    ["Offset of field: sas_header_info_s::encoding"]
        [::std::mem::offset_of!(sas_header_info_s, encoding) - 376usize];
};
pub type sas_header_info_t = sas_header_info_s;
pub const READSTAT_VENDOR_STAT_TRANSFER: _bindgen_ty_3 = 0;
pub const READSTAT_VENDOR_SAS: _bindgen_ty_3 = 1;
pub type _bindgen_ty_3 = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct sas_text_ref_s {
    pub index: u16,
    pub offset: u16,
    pub length: u16,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of sas_text_ref_s"][::std::mem::size_of::<sas_text_ref_s>() - 6usize];
    ["Alignment of sas_text_ref_s"][::std::mem::align_of::<sas_text_ref_s>() - 2usize];
    ["Offset of field: sas_text_ref_s::index"]
        [::std::mem::offset_of!(sas_text_ref_s, index) - 0usize];
    ["Offset of field: sas_text_ref_s::offset"]
        [::std::mem::offset_of!(sas_text_ref_s, offset) - 2usize];
    ["Offset of field: sas_text_ref_s::length"]
        [::std::mem::offset_of!(sas_text_ref_s, length) - 4usize];
};
pub type sas_text_ref_t = sas_text_ref_s;
extern "C" {
    pub static mut sas7bdat_magic_number: [::std::os::raw::c_uchar; 32usize];
}
extern "C" {
    pub static mut sas7bcat_magic_number: [::std::os::raw::c_uchar; 32usize];
}
extern "C" {
    pub fn sas_read8(data: *const ::std::os::raw::c_char, bswap: ::std::os::raw::c_int) -> u64;
}
extern "C" {
    pub fn sas_read4(data: *const ::std::os::raw::c_char, bswap: ::std::os::raw::c_int) -> u32;
}
extern "C" {
    pub fn sas_read2(data: *const ::std::os::raw::c_char, bswap: ::std::os::raw::c_int) -> u16;
}
extern "C" {
    pub fn sas_read_header(
        io: *mut readstat_io_t,
        ctx: *mut sas_header_info_t,
        error_handler: readstat_error_handler,
        user_ctx: *mut ::std::os::raw::c_void,
    ) -> readstat_error_t;
}
extern "C" {
    pub fn sas_subheader_remainder(len: usize, signature_len: usize) -> usize;
}
extern "C" {
    pub fn sas_header_info_init(
        writer: *mut readstat_writer_t,
        is_64bit: ::std::os::raw::c_int,
    ) -> *mut sas_header_info_t;
}
extern "C" {
    pub fn sas_write_header(
        writer: *mut readstat_writer_t,
        hinfo: *mut sas_header_info_t,
        header_start: sas_header_start_t,
    ) -> readstat_error_t;
}
extern "C" {
    pub fn sas_fill_page(
        writer: *mut readstat_writer_t,
        hinfo: *mut sas_header_info_t,
    ) -> readstat_error_t;
}
extern "C" {
    pub fn sas_validate_variable(variable: *const readstat_variable_t) -> readstat_error_t;
}
extern "C" {
    pub fn sas_validate_name(
        name: *const ::std::os::raw::c_char,
        max_len: usize,
    ) -> readstat_error_t;
}
extern "C" {
    pub fn sas_validate_tag(tag: ::std::os::raw::c_char) -> readstat_error_t;
}
extern "C" {
    pub fn sas_assign_tag(value: *mut readstat_value_t, tag: u8);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
